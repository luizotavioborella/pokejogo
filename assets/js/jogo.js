...
const personagem = {
    ...
    animar() {
        if (this.bottom > 70) {
            ...
            if (this.velocidadeY > 6) {
                this.item.style.backgroundPosition = "0px -245px"
            } else if (this.velocidadeY > 2) {
                this.item.style.backgroundPosition = "-151px -219px"
            } else if (this.velocidadeY > -2) {
                this.item.style.backgroundPosition = "-305px -214px"
            } else {
                this.item.style.backgroundPosition = "-453px -231px"
            }
        } else {
            this.item.style.animation = "moveJogador 0.4s infinite step-end"
            this.item.style.backgroundPositionY = "-64px"
        }
    },
...
document.querySelector("#btnReiniciar").addEventListener("click", function () {
    ...
    personagem.item.style.animation = "moveJogador 0.4s infinite step-end"
    personagem.item.style.backgroundPositionY = "-64px"
